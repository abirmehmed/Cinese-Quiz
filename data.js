...
const HSK_DATA = {
  ...
  "hsk4": [
    ...
    ["毕业", "bì yè", "graduation"],
    ["遍", "biàn", "everywhere"],
    ["标准", "biāo zhǔn", "(an official) standard"],
    ...
    ["尝", "cháng", "to taste"],
    ["场", "chǎng", "large place used for a specific purpose"],
    ...
    ["出发", "chū fā", "to start out"],
    ["出生", "chū shēng", "to be born"],
    ["传真", "chuán zhēn", "fax"],
    ["窗户", "chuāng hu", "window"],
    ["词典", "cí diǎn", "dictionary (of Chinese compound words)"],
    ["从来", "cóng lái", "always"],
    ["粗心", "cū xīn", "careless"],
    ["答案", "dá àn", "answer"],
