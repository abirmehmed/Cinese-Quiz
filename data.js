...
const HSK_DATA = {
  ...
  "hsk3": [
    ...
    ["比赛", "bǐ sài", "competition (sports etc)"],
    ["必须", "bì xū", "to have to"],
    ["变化", "biàn huà", "change"],
    ...
    ["聪明", "cōng ming", "acute (of sight and hearing)"],
    ["打扫", "dǎ sǎo", "to clean"],
    ["打算", "dǎ suàn", "to plan"],
    ["带", "dài", "band"],
    ["担心", "dān xīn", "anxious"],
    ["蛋糕", "dàn gāo", "cake"],
    ["当然", "dāng rán", "only natural"],
    ["地", "de", "-ly"],
    ["灯", "dēng", "lamp"],
    ["低", "dī", "low"],
    ["地方", "dì fang", "area"],
    ...
    ["冬", "dōng", "sound of beating a drum"],
    ["东", "dōng", "east"],
    ["动物", "dòng wù", "animal"],
    ...
    ["耳朵", "ěr duo", "ear"],
    ["发烧", "fā shāo", "to have a high temperature (from illness)"],
    ["发现", "fā xiàn", "to find"],
    ...
    ["关心", "guān xīn", "to care for sth"],
    ["关于", "guān yú", "pertaining to"],
    ["国家", "guó jiā", "country"],
    ...
    ["借", "jiè", "to lend"],
    ["经常", "jīng cháng", "day to day"],
    ["经过", "jīng guò", "to pass"],
    ["经理", "jīng lǐ", "manager"],
    ["久", "jiǔ", "(long) time"],
    ["旧", "jiù", "old"],
    ["举行", "jǔ xíng", "to hold (a meeting"],
    ["句子", "jù zi", "sentence"],
    ...
    ["认真", "rèn zhēn", "conscientious"],
    ["容易", "róng yì", "easy"],
    ["如果", "rú guǒ", "if"],
    ["伞", "sǎn", "umbrella"],
    ["上网", "shàng wǎng", "to be on the internet"],
    ["生气", "shēng qì", "angry"],
    ["声音", "shēng yīn", "voice"],
    ["使", "shǐ", "to make"],
    ["世界", "shì jiè", "world"],
    ...
    ["校长", "xiào zhǎng", "(college"],
    ["鞋", "xié", "shoe"],
    ["新闻", "xīn wén", "news"],
    ["新鲜", "xīn xiān", "fresh (experience"],
    ["信", "xìn", "letter"],
    ["行李箱", "xíng li xiāng", "suitcase"],
    ["兴趣", "xìng qù", "interest (desire to know about sth)"],
    ["熊猫", "xióng māo", "panda"],
    ["需要", "xū yào", "to need"],
    ["选择", "xuǎn zé", "to select"],
    ["眼镜", "yǎn jìng", "spectacles"],
    ["要求", "yāo qiú", "to request"],
    ["爷爷", "yé ye", "(informal) father's father"],
    ["一定", "yī dìng", "surely"],
    ["一共", "yī gòng", "altogether"],
    ["一会儿", "yī huì r", "a while"],
    ["一样", "yī yàng", "same"],
    ["以后", "yǐ hòu", "after"],
    ["以前", "yǐ qián", "before"],
    ["以为", "yǐ wéi", "to believe"],
    ["一般", "yī bān", "same"],
    ["一边", "yī biān", "one side"],
  ...
  "hsk4": [
    ...
    ["戴", "dài", "to put on or wear (glasses"],
    ...
    ["关键", "guān jiàn", "crucial point"],
    ["观众", "guān zhòng", "spectators"],
    ["管理", "guǎn lǐ", "to supervise"],
    ["光", "guāng", "light"],
    ["广播", "guǎng bō", "broadcast"],
    ["广告", "guǎng gào", "to advertise"],
    ["逛", "guàng", "to stroll"],
    ["规定", "guī dìng", "provision"],
    ...
    ["精彩", "jīng cǎi", "brilliant"],
    ["精神", "jīng shén", "spirit"],
    ["经济", "jīng jì", "economy"],
    ["经历", "jīng lì", "experience"],
    ["经验", "jīng yàn", "to experience"],
    ...
    ["举办", "jǔ bàn", "to conduct"],
    ["拒绝", "jù jué", "to refuse"],
    ["距离", "jù lí", "distance"],
    ["开玩笑", "kāi wán xiào", "to play a joke"],
    ["看法", "kàn fǎ", "way of looking at a thing"],
    ["考虑", "kǎo lǜ", "to think over"],
    ["棵", "kē", "classifier for trees"],
    ["科学", "kē xué", "science"],
    ["咳嗽", "ké sou", "to cough"],
    ["可怜", "kě lián", "pitiful"],
    ["可是", "kě shì", "but"],
    ["可惜", "kě xī", "it is a pity"],
    ["肯定", "kěn dìng", "to be sure"],
    ["空气", "kōng qì", "air"],
    ["恐怕", "kǒng pà", "fear"],
    ["苦", "kǔ", "bitter"],
    ["宽", "kuān", "lenient"],
    ...
    ["母亲", "mǔ qīn", "mother"],
    ["目的", "mù dì", "purpose"],
    ["耐心", "nài xīn", "to be patient"],
    ["难道", "nán dào", "don't tell me ..."],
    ...
    ["请客", "qǐng kè", "to give a dinner party"],
    ["穷", "qióng", "exhausted"],
    ...
    ["群", "qún", "group"],
    ["然而", "rán ér", "however"],
    ["热闹", "rè nao", "bustling with noise and excitement"],
    ...
    ["湿润", "shī rùn", "moist"],
    ["狮子", "shī zi", "lion"],
    ["十分", "shí fēn", "to divide into ten equal parts"],
    ["实际", "shí jì", "actual"],
    ["实在", "shí zài", "really"],
    ...
    ["提供", "tí gōng", "to offer"],
    ["提前", "tí qián", "to shift to an earlier date"],
    ...
    ["同情", "tóng qíng", "to sympathize with"],
    ["推", "tuī", "to push"],
    ...
    ["演出", "yǎn chū", "to act (in a play)"],
    ["演员", "yǎn yuán", "actor or actress"],
    ["阳光", "yáng guāng", "sunshine"],
    ["养成", "yǎng chéng", "to cultivate"],
    ...
    ["增加", "zēng jiā", "to raise"],
    ["增长", "zēng zhǎng", "to grow"],
    ["窄", "zhǎi", "narrow"],
    ["招聘", "zhāo pìn", "recruitment"],
    ["真正", "zhēn zhèng", "genuine"],
    ["整理", "zhěng lǐ", "to arrange"],
    ["整齐", "zhěng qí", "orderly"],
    ["正常", "zhèng cháng", "regular"],
    ["正好", "zhèng hǎo", "just (in time)"],
    ["正确", "zhèng què", "correct"],
    ["正式", "zhèng shì", "formal"],
    ["证明", "zhèng míng", "proof"],
    ["之", "zhī", "(possessive particle"],
    ["支持", "zhī chí", "to be in favor of"],
    ...
    ["植物", "zhí wù", "botanical"],
    ["指", "zhǐ", "finger"],
    ["只好", "zhǐ hǎo", "without any better option"],
    ["只要", "zhǐ yào", "if only"],
    ...
    ["著名", "zhù míng", "famous"],
    ["专门", "zhuān mén", "specialist"],
    ["专业", "zhuān yè", "specialty"],
    ["赚", "zhuàn", "to earn"],
    ["撞", "zhuàng", "to hit"],
